/**
 * 活动报道清单。新增报道时在此添加一项，并在 content/reports 下添加同 slug 的 .md 文件。
 */
export default [
    {
      ...
      date: '2025-09',
      summary: '电子科技大学数字文化与传媒研究中心参与青幻赛大学组工作，谢梅教授为银奖与优秀奖获得者颁奖。',
    },
    {
      slug: '2025-sci-fi-city-forum',
      title: '外国语学院举办 2025 成都科幻城市与文学高端论坛',
      date: '2025-04',
      summary: '聚焦“科幻赋能城市创新”，发布师生共创科幻小说集《群星》，探讨科幻教育未来路径。',
    },
    {
    ...
    },
    {
      ...
      date: '2023-10',
      summary: '协会以展陈与跨校互动参与世界科幻大会，联动多所高校开展留言互换、打卡与集章活动。',
    },
    {
    ...
    },
    {
      ...
      date: '2023-08',
      summary: '打造“课程+工坊+赛事”体系，举办征文大赛与科幻文化节，培养校园科幻创作新生力量。',
    },
    {
      slug: '2023-wandering-earth-2-farewell',
      title: '《流浪地球 2》成都高校告别包场观影活动举行',
      date: '2023-03',
      summary: '熊猫科幻联盟发起，成都多所高校科幻协会联合包场，共同见证中国科幻里程碑。',
    },
    {
      slug: '2022-sci-fi-writing-camp',
      title: '学校联合《科幻世界》主办首届科幻写作训练营',
      date: '2022',
      summary: '实验室参访、写作课程、电影鉴赏、文学沙龙，协会成员可关注后续机会。',
    },
  ]
